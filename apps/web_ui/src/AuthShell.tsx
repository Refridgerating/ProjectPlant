...
export function AuthShell() {
  ...
  const syncHubAuthMode = useCallback(async () => {
    ...
    try {
      ...
      const nextFleetConsoleUrl = nextControlPlaneUrl
        ? fleetConsoleUrlFromControlPlane(nextControlPlaneUrl)
        : current.fleetConsoleUrl;
      if (
        current.authMode !== nextMode ||
