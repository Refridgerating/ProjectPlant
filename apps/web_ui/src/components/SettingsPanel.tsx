...
export function SettingsPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-end bg-black/50 md:items-start">
      <div className="h-full w-full overflow-y-auto bg-slate-900 p-6 shadow-xl md:max-w-md md:border-l md:border-slate-800">
