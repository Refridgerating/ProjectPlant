...
def _normalize_status_payload(payload: dict[str, Any], pot_id: str, request_id: str | None) -> dict[str, Any]:
    ...
    aliases = {
        ...
        "schedule_timezone_posix": "scheduleTimezonePosix",
        "tz_offset_minutes_current": "tzOffsetMinutesCurrent",
    }
...
class PumpStatusPayload(BaseModel):
    ...
    scheduleTimezonePosix: str | None = None
    tzOffsetMinutesCurrent: int | None = None
