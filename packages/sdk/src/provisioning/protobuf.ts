...
function encodeSessionData(sec1Payload: Uint8Array): Uint8Array {
  return concatBytes([encodeVarintField(2, 1), encodeBytesField(11, sec1Payload)]);
}
...
export function encodeSessionCommand0(clientPublicKey: Uint8Array): Uint8Array {
  ...
  const sec1 = concatBytes([encodeVarintField(1, 0), encodeBytesField(20, cmd0)]);
...
export function encodeSessionCommand1(clientVerifyData: Uint8Array): Uint8Array {
  ...
  const sec1 = concatBytes([encodeVarintField(1, 2), encodeBytesField(22, cmd1)]);
  return encodeSessionData(sec1);
}
...
export function encodeWiFiScanStart(groupChannels = 0, periodMs = 120): Uint8Array {
  ...
  return concatBytes([encodeVarintField(1, 0), encodeBytesField(10, cmd)]);
}
...
export function encodeWiFiScanStatusRequest(): Uint8Array {
  return concatBytes([encodeVarintField(1, 2), encodeBytesField(12, new Uint8Array())]);
}
...
export function encodeWiFiScanResultRequest(startIndex: number, count: number): Uint8Array {
  const cmd = concatBytes([encodeVarintField(1, startIndex), encodeVarintField(2, count)]);
  return concatBytes([encodeVarintField(1, 4), encodeBytesField(14, cmd)]);
}
...
export function encodeWiFiConfigSet(ssid: string, passphrase: string): Uint8Array {
  ...
  return concatBytes([encodeVarintField(1, 2), encodeBytesField(12, cmd)]);
}
...
export function encodeWiFiConfigApply(): Uint8Array {
  return concatBytes([encodeVarintField(1, 4), encodeBytesField(14, new Uint8Array())]);
}
...
export function encodeWiFiConfigGetStatus(): Uint8Array {
  return concatBytes([encodeVarintField(1, 0), encodeBytesField(10, new Uint8Array())]);
}
